...
ALTER TABLE Strategy.ScreeningRule
		...
		CHECK (RuleCode IN ('TOP_N', 'MINIMUM_LISTING_YEARS', 'MINIMUM_FISHER_SCORE', 'MINIMUM_BUFFETT_SCORE', 'MINIMUM_GRAHAM_SCORE', 'REQUIRE_COMPLETE_FINANCIAL_DATA', 'EXCLUDE_ST'));
GO
