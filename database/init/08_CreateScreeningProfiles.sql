...
-- 可选：限制 RuleCode 为已知值
ALTER TABLE Strategy.ScreeningRule ADD CONSTRAINT CK_Strategy_ScreeningRule_Code CHECK (RuleCode IN ('TOP_N','MINIMUM_LISTING_YEARS','MINIMUM_FISHER_SCORE','MINIMUM_BUFFETT_SCORE','MINIMUM_GRAHAM_SCORE','MINIMUM_FINAL_SCORE','REQUIRE_COMPLETE_FINANCIAL_DATA','EXCLUDE_ST'));
GO
